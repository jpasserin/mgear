...
// GLOBAL
/////////////////////////////////////////////////
MTypeId gear_ikfk2Bone::id( 0x27004 );

// Define the Node's attribute specifiers

MObject gear_ikfk2Bone::blend;

MObject gear_ikfk2Bone::lengthA; 
MObject gear_ikfk2Bone::lengthB; 
MObject gear_ikfk2Bone::negate; 
MObject gear_ikfk2Bone::scaleA; 
MObject gear_ikfk2Bone::scaleB; 
MObject gear_ikfk2Bone::roll; 
MObject gear_ikfk2Bone::maxstretch; 
MObject gear_ikfk2Bone::slide; 
MObject gear_ikfk2Bone::softness; 
MObject gear_ikfk2Bone::reverse; 

MObject gear_ikfk2Bone::root; 
MObject gear_ikfk2Bone::ikref; 
MObject gear_ikfk2Bone::upv;
MObject gear_ikfk2Bone::fk0;	
MObject gear_ikfk2Bone::fk1;	
MObject gear_ikfk2Bone::fk2;		

MObject gear_ikfk2Bone::inAparent; 
MObject gear_ikfk2Bone::inBparent; 
MObject gear_ikfk2Bone::inCenterparent; 
MObject gear_ikfk2Bone::inEffparent; 

MObject gear_ikfk2Bone::outA; 
MObject gear_ikfk2Bone::outB; 
MObject gear_ikfk2Bone::outCenter; 
MObject gear_ikfk2Bone::outEff; 

gear_ikfk2Bone::gear_ikfk2Bone() {} // constructor
gear_ikfk2Bone::~gear_ikfk2Bone() {} // destructor
...
// CREATOR ======================================
void* gear_ikfk2Bone::creator()
{
   return new gear_ikfk2Bone();
}

// INIT =========================================
MStatus gear_ikfk2Bone::initialize()
{
...
// COMPUTE ======================================
MStatus gear_ikfk2Bone::compute(const MPlug& plug, MDataBlock& data)
{
...
MTransformationMatrix gear_ikfk2Bone::getIKTransform(s_GetIKTransform data, MString name){
...
MTransformationMatrix gear_ikfk2Bone::getFKTransform(s_GetFKTransform data, MString name){
